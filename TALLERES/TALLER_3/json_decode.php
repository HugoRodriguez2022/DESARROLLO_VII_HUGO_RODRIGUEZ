...
$jsonPelicula = '{"titulo":"Salvar al Soldado Ryan","director":"Steven Spielberg","año":1998,"actores":["Tom Hanks","Matt Damon","Vin Diesel"]}';
...
$jsonvalido = '{"nombre": "Pedro", "edad": 35}'; // JSON inválido 
$resultado = json_decode($jsonvalido);
if (json_last_error() !== JSON_ERROR_NONE) {
    echo "</br>Error al decodificar JSON: " . json_last_error_msg();
}
?>
