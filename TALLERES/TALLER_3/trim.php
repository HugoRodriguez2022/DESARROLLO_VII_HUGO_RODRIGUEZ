...
$textoOeste = " Oeste  ";
$textoEste = " Este    ";
echo "</br>Trim Oeste: '" . ltrim($textoOeste) . "'</br>";
echo "Trim Este: '" . rtrim($textoEste) . "'</br>";
...
function limpiarFrase($frase, $caracteresindeseados = " 	</br>
") {
    return trim($frase, $caracteresindeseados);
}

$cadenaAntes = "	</br>El motor es una maravilla!@#@ ";
$cadenaDespues = limpiarFrase($cadenaAntes, " 	</br>
@#");
echo "</br>Cadena sucia: '$cadenaAntes'</br>";
echo "Cadena limpia: '$cadenaDespues'</br>";
?>
