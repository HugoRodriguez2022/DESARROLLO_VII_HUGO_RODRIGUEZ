...
echo "Contraseña aleatoria (8 caracteres): " . generarContraseña(8) . "</br>";
...
$jugador = 'Piedra'; // Puedes cambiar esto a 'Papel' o 'Tijeras'

// Elección de la computadora
$computadora = eleccionComputadora();

echo "Tú elegiste: $jugador</br>";
echo "La computadora eligió: $computadora</br>";

echo "Resultado: " . determinarGanador($jugador, $computadora) . "</br>";
