...
$frutas = ["piña", "mandarina", "naranja", "uva"];
$buscar = "naranja";
...
$diasBuscar = ["lunes", "sábado", "festivo","navidad","viernes","domingo"];
...
$personas = [
    ...
    ["nombre" => "Nicolas", "edad" => 28]

];

$buscarPersona = ["nombre" => "Nicolas", "edad" => 28];
...
$colores = ["amarillo", "purpura", "azul", "marron"];
$buscarColor = "purpura";

echo "</br></br>Buscando '$buscarColor' en lista de colores:</br>";
echo in_array_case_insensitive($buscarColor, $colores) ? "Encontrado" : "No encontrado";
?>
