...
$minombreCompleto = "Hugo Rodríguez";
$minombre = substr($minombreCompleto, 0, strpos($minombreCompleto, " "));
$miapellido = substr($minombreCompleto, strrpos($minombreCompleto, " ") + 1);
echo "</br>Nombre completo: $minombreCompleto</br>";
echo "Nombre: $minombre</br>";
echo "Apellido: $miapellido</br>";
...
function extraeEntre($texto, $inicio, $fin) {
    $inicioPos = strpos($texto, $inicio);
    if ($inicioPos === false) return "";
...
$textoHTML = "<h2>Mi Titulo</h2>";
echo "</br>Texto HTML: $textoHTML</br>";
echo "Contenido extraído: " . extraeEntre($textoHTML, "<h2>", "</h2>") . "</br>";
?>
