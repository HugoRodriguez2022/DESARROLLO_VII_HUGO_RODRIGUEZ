...
$miArray = ["Tomate", "Zanahoria", "Repollo"]; // Reemplaza esto con tu propio array
$miString = "Hugo"; // Reemplaza esto con tu propio string
$miNumero = 91; // Reemplaza esto con tu propio número
...
echo "</br>Pruebas de la función procesarDato():</br>";
procesadorDato([8, 9, 0]);
procesadorDato("Hola mundo soy Hugo");
procesadorDato(34);
?>
