...
$categoria_id = 2; // Por ejemplo, el ID de la categoría es 2
...
// Usamos bindParam para enlazar el valor de categoria_id como un entero
$stmt->bindParam(':categoria_id', $categoria_id, PDO::PARAM_INT);

// Ejecutamos la consulta
$stmt->execute();

// Si necesitas obtener los resultados
